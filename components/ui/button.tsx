    ...
    return (
      ...
      >
        {Icon &&
          iconPlacement === "left" &&
          (effect === "expandIcon" ? (
            <div className="flex max-w-0 items-center overflow-hidden transition-all duration-200 group-hover:mr-2 group-hover:max-w-5">
              <Icon />
            </div>
          ) : (
            <Icon />
        ...
        {Icon &&
          iconPlacement === "right" &&
          (effect === "expandIcon" ? (
            <div className="flex w-0 translate-x-[100%] items-center pl-0 opacity-0 transition-all duration-200 group-hover:w-5 group-hover:translate-x-0 group-hover:pl-2 group-hover:opacity-100">
              <Icon />
            </div>
          ) : (
            <Icon />
