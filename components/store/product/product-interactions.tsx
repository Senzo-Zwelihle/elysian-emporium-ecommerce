...
export function ProductInteractions({
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Tracking engagement for {productName}
          </CardDescription>
        </CardHeader>
        <CardContent>
  ...
  const totalInteractions =
    stats.views + stats.shares + stats.addToCart + stats.favorites
  const engagementRate =
    stats.views > 0 ? Math.round((totalInteractions / stats.views) * 100) : 0
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font-medium">
              {stats.addToCart.toLocaleString()}
            </span>
          </div>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
